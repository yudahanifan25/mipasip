...
class Log_trx_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if (isset($params['student_nis'])) {
         ...
         if (isset($params['log_trx_bebas_date'])) {
            $this->db->where('log_trx_bebas_date', $params['log_trx_bebas_datex']);
        }
        ...
        $this->db->select('log_trx.log_trx_id, log_trx_input_date, log_trx_bebas_date, log_trx_last_update');
    ...
    function add($data = array()) {
        ...
        if (isset($data['log_trx_bebas_date'])) {
            $this->db->set('log_trx_bebas_date', $data['log_trx_bebas_date']);
        }
