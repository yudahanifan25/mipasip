...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/debit') ?>">Pemasukan Umum</a></li>
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
								...
								<input class="form-control" type="text" name="debit_date" readonly="readonly" placeholder="Tanggal Pemasukan" value="<?php echo $inputDateValue; ?>">
							</div>
						</div>

						<div class="form-group">
							<label>Keterangan *</label>
							<input type="text" class="form-control" name="debit_desc" value="<?php echo $inputDescValue ?>" placeholder="Keterangan Pemasukan">
						</div>
