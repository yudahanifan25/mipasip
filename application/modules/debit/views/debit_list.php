				...
				<div class="box box-primary">
					<?php if ($this->session->userdata('uroleid') <> BENDAHARA) { ?>
						<div class="box-header with-border">
							<div class="row">
								<div class="col-sm-6">
									<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addDebit"><i class="fa fa-plus"></i> Tambah</button>
								</div>
								<div class="col-sm-6">
									<div class="box-tools pull-right">
										<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'method' => 'get')) ?>
										<div class="input-group input-group-sm">
											<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Cari Pemasukan Umum"' ?> class="form-control" required>
								...
								?>
										<tr>
											...
											<td class="text-center">
												<?php if ($this->session->userdata('uroleid') <> BENDAHARA) { ?>
													<a href="<?php echo site_url('manage/debit/edit/' . $row['debit_id']) ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
													<a href="#delModal<?php echo $row['debit_id']; ?>" data-toggle="modal" class="btn btn-sm btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
												<?php } ?>
											</td>
										</tr>
				...
				<div id="p_scents_debit">
					<div class="form-group">
						...
						<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
							...
							<input class="form-control" required="" type="text" name="debit_date" placeholder="Tanggal Pemasukan">
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<label>Keterangan *</label>
							<input type="text" required="" name="debit_desc[]" class="form-control" placeholder="Keterangan Pemasukan">
						</div>
						<div class="col-md-6">
							...
							<input type="text" required="" name="debit_value[]" class="form-control numeric" placeholder="Jumlah">
						</div>
					</div>
				</div>
