...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/students') ?>">Manajemen Mahasiswa</a></li>
			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_2" data-toggle="tab">Data Akademik</a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab_2">
							<div class="form-group">
								<label>Nomor Pokok Mahasiswa (NPM) <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
								<input name="student_nis" type="text" class="form-control" value="<?php echo $inputNisValue ?>" placeholder="NPM" required>
							</div>
							...
							<?php if ($setting_level['setting_value'] == 'senior') { ?>
								<div class="form-group">
									<label>Prodi <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
							...
							<div ng-controller="classCtrl">
								<div class="form-group">
									...
									<br>
									<a data-toggle="modal" href="#myModal" class="btn btn-primary"><span class="fa fa-plus"></span> Tambah Semester</a>
											...
											<div class="modal-dialog modal-sm">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title" id="myModalLabel">Tambah Semester</h4>
													</div>
													<div class="modal-body">
														<label>Nama Semester *</label>
														<input type="text" name="class_name" ng-model="classForm.class_name" placeholder="Semester" class="form-control"><br>
													</div>
			...
			<div class="col-md-3">
				<div class="box box-solid">
					...
					<div class="box-footer">
						...
						<a href="<?php echo site_url('manage/student'); ?>" class="btn btn-sm bg-gray text-bold"><i class="fa fa-close"></i> Batal</a>
						<?php if (isset($student)) { ?>
