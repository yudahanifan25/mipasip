...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/class') ?>">PEMBAYARAN</a></li>
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input name="month_name" type="text" class="form-control" value="<?php echo $inputMonthValue ?>" placeholder="Isi Nama Pembayaran">
						</div>
			...
			<div class="col-md-3">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/month'); ?>" class="btn btn-block btn-info"><i class="fa fa-close"></i> Batal</a>
					</div>
					<!-- /.box-body -->
				</div>
			</div>
