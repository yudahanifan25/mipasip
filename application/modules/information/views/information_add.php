			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<button name="action" type="submit" value="save" class="btn btn-sm btn-success btn-form"><i class="fa fa-check"></i> Simpan</button>
							<a href="<?php echo site_url('manage/information'); ?>" class="btn btn-sm btn-info btn-form"><i class="fa fa-arrow-left"></i> Batal</a>
							<?php if (isset($information)) : ?>
								<a href="<?php echo site_url('manage/information/delete/' . $information['information_id']); ?>" class="btn btn-sm btn-danger btn-form pull-right"><i class="fa fa-trash"></i> Hapus</a>
							<?php endif; ?>
						</div>
					</div>
				</div>
