								...
								?>
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo site_url('manage/information/edit/' . $row['information_id']) ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square"></i></a>
												<a href="#delModal<?php echo $row['information_id']; ?>" data-toggle="modal" class="btn btn-sm btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
											</td>
										</tr>
