...
class Bebas_pay_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        if (isset($params['class_id'])) {
         ...
         if (isset($params['bebas_date'])) {
            $this->db->where('bebas_date', $params['bebas_date']);
        }
        ...
        $this->db->select('bebas_pay.bebas_pay_id, bebas_pay_bill, bebas_pay_number, bebas_pay_desc, bebas_date, bebas_pay_input_date, bebas_pay_last_update');
        $this->db->select('bebas_pay.bebas_bebas_id, bebas_bill, bebas_total_pay');
        $this->db->select('student_student_id, student_nis, student.class_class_id, class_name, student_full_name, student_name_of_mother, student_parent_phone, student.majors_majors_id, majors_name, majors_short_name');
    ...
    function add($data = array())
    {
        ...
        if (isset($data['bebas_date'])) {
            $this->db->set('bebas_date', $data['bebas_date']);
        }
