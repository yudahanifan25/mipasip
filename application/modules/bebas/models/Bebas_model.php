...
class Bebas_model extends CI_Model
{
  ...
  function get($params = array())
  {
   ...
   if (isset($params['date'])) {
            $this->db->where('bebas_input_date', $params['date']);
     }
    ...
    if (isset($params['bebas_bebas_date'])) {
      $this->db->where('bebas_bebas_date', $params['bebas_bebas_date']);
    }
    ...
    $this->db->select('bebas.bebas_id, bebas_bill, bebas_total_pay, bebas_desc, bebas_bebas_date, bebas_input_date, bebas_last_update');
    $this->db->select('student_student_id, student_status, student_img, student_nis, student_full_name, student_name_of_mother, student_parent_phone, student.class_class_id, class_name, student_full_name, student_nis, student_name_of_mother, student_parent_phone, student.majors_majors_id, majors_name, majors_short_name');
    $this->db->select('payment_payment_id, pos_name, payment_type, period_period_id, period_status, period_start, period_end');
  ...
  function add($data = array())
  {
    ...
    if (isset($data['bebas_bebas_date'])) {
      $this->db->set('bebas_bebas_date', $data['bebas_bebas_date']);
    }
