				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<label for="" class="col-sm-1 control-label">Semester</label>
							<div class="col-sm-2">
						...
						<div class="col-sm-10">
							<a class="btn btn-primary btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Semester</a>
							<?php if (majors() == 'senior') { ?>
								<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_majors/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Prodi</a>
							<?php } ?>
							<a class="btn btn-info btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_student/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Mahasiswa</a>
