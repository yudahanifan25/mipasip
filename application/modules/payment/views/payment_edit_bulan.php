					...
					<div class="box box-success">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<strong><input type="text" class="form-control" value="<?php echo $payment['pos_name'] . ' - T.A ' . $payment['period_start'] . '/' . $payment['period_end'] ?>" readonly=""></strong>
								</div>
							</div>
							<div class="form-group">
				...
				<div class="col-md-7">
					<div class="box box-success">
						...
						<div class="box-footer">
							<button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Update Tarif</button>
