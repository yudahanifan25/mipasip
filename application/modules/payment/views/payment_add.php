			...
			<div class="col-md-9">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label>Tahun Akademik <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
						...
						<div class="form-group">
							<label>Tipe Pembayaran <small data-toggle="tooltip" title="Wajib diisi">*</small></label><br>
			...
			<div class="col-md-3">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/payment'); ?>" class="btn btn-block btn-info"><i class="fa fa-repeat"></i> Batal</a>
						<?php if (isset($payment['payment_id'])) { ?>
							<button type="button" onclick="getId(<?php echo $payment['payment_id'] ?>)" class="btn btn-danger btn-block" data-toggle="modal" data-target="#deletePayment"><i class="fa fa-close"></i> Hapus
							</button>
						<?php } ?>
					</div>
					<!-- /.box-body -->
