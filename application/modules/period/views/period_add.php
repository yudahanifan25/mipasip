...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/period') ?>">Tahun Akademik</a></li>
			...
			<div class="col-md-3">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/period'); ?>" class="btn btn-block btn-info"><i class="fa fa-close"></i> Batal</a>
					</div>
					<!-- /.box-body -->
				</div>
			</div>
