...
<body>
  ...
  <p class="title" style="padding-top: -10px; margin-top: 0px;"><br>UNIVERSITAS GARUT<br>FAKULTAS MATEMATIKA DAN ILMU PENGETAHUAN ALAM</p>
...
<br>
  ...
  <?php if ($f['n'] and $f['r'] != NULL) { ?>
    <table style="border-style: solid;" width=104%" height=30%  style="font-size: 10px;" border="1">
      ...
      <tr>
        ...
        <th style="background-color: #dedede; font-weight:bold; border-bottom: 0px solid;" >NAMA PEMBAYARAN</th>
          <th style="background-color: #dedede; font-weight:bold; border-bottom: 0px solid;" >TAGIHAN</th>
    ...
    -->
      ...
      foreach ($bebas as $row) :
        // $namePayFree = $row['pos_name'] . ' - T.A ' . $row['period_start'] . '/' . $row['period_end']; tangaal row $row ['pos_name']
      ...
      ?>
        ...
        <tr>
          ...
          <td style="padding:0 5px; text-align: center;<?php echo ($row['bebas_total_pay'] > 0) ? 'left' : '' ?>"><?php echo ($row['bebas_total_pay'] > 0) ? pretty_date($row['bebas_bebas_date'], 'Y-m-d', false) : '<strong>Belum Melakukan Pembayaran'  ?></td>
 ...
 <tr>
        <td colspan="2" style="background-color: #dedede; font-weight:bold; border-bottom: 0px ; border-right: 0px; border-left: 1px solid; border-top: 1px solid;  padding-bottom: 8px; padding-top: 8px;" align="center"><strong>Total</td>
...
<td style=" background-color: #FFFFFF; border-bottom: 0px ; border-left: 0px; border-right:0px; text-align: right;"></td>
<td style=" background-color: #dedede; border-bottom: 0px ; border-left: 0px; border-right: 0px; text-align: right;"><strong> Rp.<?php echo number_format($summonth + $sumbeb, 0, ',', '.') ?></strong></td>
<td style=" background-color: #dedede; border-bottom: 0px ; border-left: 0px; border-right:0px; text-align: right;"><strong>Rp.<?php echo number_format($total_bebas - $total_bebas_pay, 0, ',', '.') ?></strong></td>
<td style="background-color: #dedede; border-left: 0px; border-right-color: #FFFFFF; border-bottom: 0px; border-left: 0px;"></td>
</tr>


      <tr>
        <td colspan="2" style="background-color: #dedede; font-weight:bold; border-bottom: 0px ; border-right: 0px; border-left: 1px solid; border-top: 1px solid;  padding-bottom: 8px; padding-top: 8px;" align="left"><strong>TOTAL KEWAJIBAN PEMBAYARAN</td>
        <td style="background-color: #dedede; font-weight:bold; border-bottom: 0px ; border-left: 0px; border-right: 0px; font-size: 12px;" align="right"><strong> <?php echo 'Rp. ' .number_format($total_bebas, 0, ',', '.') ?></strong></td>

     
<td colspan="4" style=" background-color: #FFFFFF; border-bottom: 0px ; border-left: 0px; border-right-color: #FFFFFF; text-align: right;"></td>
</tr>
...
-->
       ...
       <!--
          ...
          --> 
          <!--
           <td style="background-color: #dedede; font-weight:bold; border-bottom: 0px solid; border-left: 0px; border-right: 0px;" align="center">
           
      </th>
  </tr>
-->
  <tr>
    <td style="background-color: #dedede; border-right: 0px; border-left: 1px solid; border-bottom: 0px solid; border-top: 1px solid; padding-bottom: 5px; padding-top: 5px; " colspan="2"><strong>
      TOTAL SUDAH DIBAYAR</strong>
    </td>
    <td style="background-color: #dedede; border-right: 0px; border-left: 0px; border-bottom: 0px solid; border-top: 1px solid; text-align: right; font-size: 12px;" colspan="1"><strong>
      <?php echo 'Rp.&nbsp;&nbsp; ' .number_format($summonth + $sumbeb, 0, ',', '.') ?></strong>
    </td>
  </tr>
  <tr>
    <td style="background-color: #dedede; border-right: 0px; border-left: 1px solid; border-bottom: 0px solid; border-top: 1px solid; padding-bottom: 5px; padding-top: 5px;" colspan="2"><strong>
      TOTAL SISA TAGIHAN</strong>
    </td>
    <td style="background-color: #dedede; border-right: 0px; border-left: 0px; border-bottom: 0px solid; border-top: 1px solid; text-align: right; font-size: 12px;"><strong>
      <?php echo 'Rp. ' .number_format($total_bebas - $total_bebas_pay, 0, ',', '.') ?></strong>
    </td>
  </tr>
