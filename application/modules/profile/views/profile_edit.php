				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="user_description" placeholder="Keterangan"><?php echo $inputDescValue ?></textarea>
						</div>
			...
			<div class="col-md-3">
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/profile'); ?>" class="btn btn-block btn-info"><i class="fa fa-close"></i> Batal</a>
					</div>
					<!-- /.box-body -->
				</div>
			</div>
